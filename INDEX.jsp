<%-- 
    Document   : index
    Created on : Mar 25, 2026, 8:01:05 AM
    Author     : Lenovo
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="SCHEMA.BAN" %>
<%@page import="ProcessData.BANS" %>
            ...
            <div id="main_content">
                ...
                <div class="center_content">     
                    <div class="prod_box">
                        <%
                            BANS bans = new BANS();
                            for (BAN ban : bans.getListBan()) {
                        %>
                        <div class="top_prod_box"></div>
                        <div class="center_prod_box">
                            <div class="product_title"><a href="details.html"><%=ban.getTenBan()%></a></div>
                            <div class="product_img"><a href="details.html">
                                    <img src="<%=(ban.isTrangThai() == true ? "BAN2.png" : "BAN1.png")%>" alt="" border="0" /></a>
                            </div>
                            <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
                        </div>
